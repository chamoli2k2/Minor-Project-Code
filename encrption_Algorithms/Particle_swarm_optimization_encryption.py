...
def particle_swarm_optimization_encryption(image, key):
    """
    Encrypt the image using Particle Swarm Optimization logic with the provided key.
    """
...
if __name__ == "__main__":
    ...
    os.makedirs("psoImages", exist_ok=True)
    ...
    cv2.imwrite("psoImages/encrypted_lena.png", encrypted_image)

    print("PSO Encryption completed! Image saved in psoImages folder.")
